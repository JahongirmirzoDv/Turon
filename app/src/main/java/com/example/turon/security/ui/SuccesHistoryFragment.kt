...
class SuccesHistoryFragment : Fragment() {
    private var _binding: FragmentSuccesHistoryBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSuccesHistoryBinding.inflate(inflater, container, false)
        return binding.root
    }
