...
class TurnHistoryDataSource(private var apiService: ApiService,private var text:String) : PagingSource<Int, TurnHistory>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, TurnHistory> {
        ...
        try {
            ...
            val response = apiService.getTurnHistory(page,userId,text)
