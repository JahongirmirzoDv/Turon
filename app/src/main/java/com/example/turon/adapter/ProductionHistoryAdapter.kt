...
import com.example.turon.utils.SingleBlock

class ProductionHistoryAdapter  : PagingDataAdapter<HistoryProData, ProductionHistoryAdapter.ViewHolder>(BDiffUtilCallback()) {
...
class BDiffUtilCallback : DiffUtil.ItemCallback<HistoryProData>() {
