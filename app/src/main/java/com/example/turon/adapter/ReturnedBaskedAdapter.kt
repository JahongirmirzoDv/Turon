...
class ReturnedBaskedAdapter  (
    private var list: ArrayList<ReturnedBasked>,
    private var onReturnBaskedClickListener: OnReturnBaskedClickListener
) :
    RecyclerView.Adapter<ReturnedBaskedAdapter.VH>() {
    ...
    interface OnReturnBaskedClickListener {
        fun onItemClickReturnBasked(position: ReturnedBasked)
